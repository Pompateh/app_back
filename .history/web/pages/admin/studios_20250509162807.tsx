        ...
        <>
          ...
          <form onSubmit={handleSubmit} className="mt-4 space-y-4">
            ...
            <div className="mt-4">
              ...
              <button onClick={addPortfolioItem} className="mt-2 text-blue-500">+ Add Portfolio Item</button>
            </div>
            ...
            <div className="mt-4">
              ...
              <button onClick={addFontItem} className="mt-2 text-blue-500">+ Add Font Item</button>
            </div>
            ...
            <div className="mt-4">
              ...
              <button onClick={addArtworkItem} className="mt-2 text-blue-500">+ Add Artwork Item</button>
            </div>
