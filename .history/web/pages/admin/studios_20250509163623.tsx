...
<div className="mt-4">
  ...
  {formData.portfolio.map((item, index) => (
    <div key={index} className="flex items-center space-x-2 mt-2">
      ...
      <input
        type="file"
        onChange={(e) => handleImageChange(e, `portfolio[${index}].image`)}
        className="border p-2 rounded flex-1"
      />
      {item.image && <img src={item.image} alt="Portfolio" className="w-16 h-16 object-cover" />}
      <input
        type="text"
        placeholder="Type"
        value={item.type}
...
<div className="mt-4">
  ...
  {formData.fonts.map((item, index) => (
    <div key={index} className="flex items-center space-x-2 mt-2">
      ...
      <input
        type="file"
        onChange={(e) => handleImageChange(e, `fonts[${index}].image`)}
        className="border p-2 rounded flex-1"
      />
      {item.image && <img src={item.image} alt="Font" className="w-16 h-16 object-cover" />}
      <input
        type="text"
        placeholder="Type"
        value={item.type}
...
<div className="mt-4">
  ...
  {formData.artworks.map((item, index) => (
    <div key={index} className="flex items-center space-x-2 mt-2">
      ...
      <input
        type="file"
        onChange={(e) => handleImageChange(e, `artworks[${index}].image`)}
        className="border p-2 rounded flex-1"
      />
      {item.image && <img src={item.image} alt="Artwork" className="w-16 h-16 object-cover" />}
      <input
        type="text"
        placeholder="Type"
        value={item.type}
