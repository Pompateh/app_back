...
const AdminProjects: React.FC = () => {
  ...
  const saveProject = async () => {
    ...
    try {
      if (formData.id) {
        ...
        const updateData = { ...rest, blocks: cleanedBlocks, team: cleanedTeam };
  ...
  <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4 max-h-[90vh] overflow-y-auto w-full lg:w-[90vw]">
    {/* Form Section */}
