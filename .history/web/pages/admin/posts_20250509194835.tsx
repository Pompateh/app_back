...
<table className="min-w-full bg-white border shadow mb-8">
  <thead>
    <tr className="bg-gray-100">
      <th className="py-2 px-4 border-b text-left">Title</th>
      <th className="py-2 px-4 border-b text-left">Published</th>
  ...
  <tbody>
    {posts.map(post => (
      <tr key={post.id} className="hover:bg-gray-50">
        <td className="py-2 px-4 border-b flex items-center">{post.title}</td>
        <td className="py-2 px-4 border-b flex items-center">{post.published ? 'Yes' : 'No'}</td>
        <td className="py-2 px-4 border-b flex items-center">{post.publishedAt ? new Date(post.publishedAt).toLocaleString() : '—'}</td>
        <td className="py-2 px-4 border-b flex items-center">
          <button onClick={() => handleEdit(post)} className="mr-2 text-blue-500 hover:underline">Edit</button>
