    ...
    switch (block.type) {
      case 'text':
        return (
          <>
                        {block.layout === 'right' && (
              <div className="border-t-2 border-l-2 border-b-0 border-[#999380] md:col-start-1 md:col-span-1 "></div>
            )}
                        {block.layout === 'left' && (
              <div className="border-t-1 border-r-2 border-b-0 border-[#999380] md:col-start-1 md:col-span-1 "></div>
            )}
            <div
              key={idx}
