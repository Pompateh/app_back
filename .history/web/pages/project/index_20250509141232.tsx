      ...
      case 'text':
        return (
          <>
            ...
            {block.layout === 'left' && (
              <div className="border-2 border-l border-[#999380] md:col-start-2 md:col-span-1"></div>
            )}
          </>
        );
      case 'full_image': {
        ...
        return (
          <div key={idx} className="grid grid-cols-2 grid-rows-2 gap-0 md:col-span-2">
            {block.data.items.map((item, i) => {
              let cellClass = '';
              let borderClass = 'border-2 border-b  border-[#999380] overflow-hidden';
              
              if (i === 0) {
                cellClass = 'row-start-1 col-start-1';
                borderClass = 'border-t-2 border-l-2 border-b border-[#999380] overflow-hidden';
              }
              if (i === 1) {
                cellClass = 'row-start-2 col-start-1';
                borderClass = ' border-b-2 border-[#999380] overflow-hidden border-l-2 border-b';
              }
              if (i === 2) {
