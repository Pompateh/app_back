  ...
  return (
      ...
      <div className="container mx-auto">
        {featuredPost && (
          <div className="grid grid-cols-1 md:grid-cols-2">
            {/* Left Half */}
            <div className="flex flex-col space-y-4 mt-20 md:col-span-1 pr-6">
    ...
    />
            ...
            <div className="flex flex-col space-y-8 mt-4 md:col-span-1 border-l-2 border-[#999380] ml-0">
              ...
              <div
                className="absolute top-0 right-0 h-full bg-black px-16 py-32 rounded shadow overflow-hidden flex items-center justify-center"
                style={{
                  /* 
                   * Make this panel 60% of the viewport width (tweak as you like),
                   * so it extends past the container into the white gutter.
                   */
                  width: '60vw',
                }}
              >
