...
const NewsListing: NextPage = () => {
  ...
  return (
    <Layout>
      ...
      <div className="container">
        {featuredPost && (
            ...
            {/* Left Half */}
            <div className="flex flex-col space-y-4 mt-20 md:col-span-3 ml-4">
    ...
    />
            ...
            {/* Right Half */}
            <div className="flex flex-col space-y-8 mt-4 md:col-span-4 border-l-2 border-[#999380] pl-0 mr-0">
