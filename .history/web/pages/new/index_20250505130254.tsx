...
const NewsListing: NextPage = () => {
  ...
  return (
    <Layout>
      <VerticalLine />
      <div className="w-full" style={{ marginLeft: '274px', marginRight: '0' }}>
        {featuredPost && (
            <div className="grid grid-cols-1 md:grid-cols-13" style={{ columnGap: '2.375rem' }}>
            {/* Left Half */}
            <div className="flex flex-col space-y-4 mt-20 md:col-span-4 md:ml-[-75px]">
    ...
    />
            ...
            {/* Right Half */}
            <div className="flex flex-col space-y-8 mt-4 md:col-span-7 border-l-2 border-[#999380] pl-0">
              <div className="flex flex-row justify-end items-start space-x-4 relative">
                ...
                {featuredPost.referencePicUrl && isImageExpanded && (
                  <div className="relative w-4/6 bg-black px-16 py-32 rounded shadow overflow-hidden flex flex-col items-center justify-center" style={{ height: '100%' , width: '100%' }}>
                    <img
