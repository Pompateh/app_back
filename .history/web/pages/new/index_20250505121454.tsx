...
const NewsListing: NextPage = () => {
  ...
  return (
    <Layout>
      <VerticalLine />
      <div className="container mx-auto" style={{ marginLeft: '200px', marginRight: '0' }}>
        {featuredPost && (
            ...
            <div className="flex flex-col space-y-8 mt-4 md:col-span-1 border-l-2 border-[#999380] ml-0">
              <div className="flex flex-row justify-end items-start space-x-4 relative">
                ...
                {featuredPost.referencePicUrl && isImageExpanded && (
                  <div className="relative w-8/6 bg-black px-16 py-32 rounded shadow overflow-hidden flex flex-col items-center justify-center" style={{ height: '100%' }}>
                    <img
