...
const NewsListing: NextPage = () => {
  ...
  return (
      ...
      <div className="flex w-full">
        {featuredPost && (
          <div className="grid grid-cols-1 md:grid-cols-1">
            {/* Left Half */}
            <div className="flex flex-col space-y-4 mt-20 pr-6">
    ...
    />
            ...
            {/* Right Half */}
            <div className="flex-1 border-l-2 border-[#999380] px-6">
                <div className="flex flex-col space-y-8 mt-4 border-l-2 border-[#999380] ml-0">
