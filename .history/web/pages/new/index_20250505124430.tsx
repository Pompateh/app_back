...
const NewsListing: NextPage = () => {
  ...
  return (
    <Layout>
      <VerticalLine />
      <div className="container ml-46">
        {featuredPost && (
          <div className="grid grid-cols-1 md:grid-cols-2">
            {/* Left Half */}
            <div className="flex flex-col space-y-4 mt-20 md:col-span-1 pr-6" style={{ marginLeft: '0px' }}>
            ...
            <div className="flex flex-row justify-end items-start space-x-4 relative" style={{ width: '100%' }}>
                ...
                {featuredPost.referencePicUrl && isImageExpanded && (
                  <div className="relative w-5/6 bg-black px-16 py-32 rounded shadow overflow-hidden flex flex-col items-center justify-center" style={{ height: '100%' }}>
                    <img
