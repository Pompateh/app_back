...
const NewsListing: NextPage = () => {
  ...
  return (
      ...
      <div className="w-full" style={{ paddingLeft: '200px', marginRight: '0' }}>
        {featuredPost && (
          <div className="grid grid-cols-1 md:grid-cols-5">
            {/* Left Half */}
            <div className="flex flex-col space-y-4 mt-20 md:ml-[-75px] md:col-span-2 pr-12">
    ...
    />
            ...
            {/* Right Half */}
            <div className="flex flex-col space-y-8 mt-4 md:col-span-3 border-l-2 border-[#999380] ml-0">
