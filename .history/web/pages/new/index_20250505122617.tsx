      ...
      <div className="container">
        {featuredPost && (
          <div className="grid grid-cols-1 md:grid-cols-2 w-full">
            ...
            {/* Right Half */}
            <div className="flex flex-col space-y-8 mt-4 md:col-span-1 border-l-2 border-[#999380] ml-0 w-full">
              <div className="flex flex-row justify-end items-start space-x-4 relative w-full">
                <div className="p-4 mt-24 relative w-full">
